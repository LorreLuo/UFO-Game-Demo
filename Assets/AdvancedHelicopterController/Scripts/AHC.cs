...
namespace alelavoie
{
    public class AHC : MonoBehaviour
    {
        ...
        {            
            ...
            Vector3 hVelocity = new Vector3(HeliRigidbody.linearVelocity.x, 0, HeliRigidbody.linearVelocity.z); 
        }
        ...
        private void InitRigidbody() {
            ...
            HeliRigidbody.linearDamping = Mathf.Lerp(0.001f, 0.1f, HelicopterDragCoefficient);
            HeliRigidbody.mass = 500;
            HeliRigidbody.angularDamping = 10f;          
        ...
        {
            if (HeliRigidbody.linearVelocity.magnitude <= 0.1f) {

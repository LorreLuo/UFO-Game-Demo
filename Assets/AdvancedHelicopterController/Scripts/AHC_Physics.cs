...
namespace alelavoie
{
    class AHC_Physics
    {
        ...
        private Vector3 AltitudeStabilizer()
        {
            ...
            float heliVeloDirectionY = _ahc.HeliRigidbody.linearVelocity.normalized.y;
        ...
        {
            Vector3 VeloOnHeliPlane = Vector3.ProjectOnPlane(_ahc.HeliRigidbody.linearVelocity, _ahc.transform.up);
        ...
        private float SpeedModulationFactor(float speed)
        {
            ...
            return (ANGULAR_DRAG_COEFICIENT * _ahc.HeliRigidbody.angularDamping) * Mathf.Pow(speed - MIN_SPEED_ANGURAL_DRAG, 2f);
        }
        ...
        {
            Vector3 dragDirection = -_ahc.HeliRigidbody.linearVelocity.normalized;
            float angleDragHeliUp = Vector3.Angle(dragDirection, _ahc.transform.up);
            float rotorDragStrength = ComputRotorDragStrength(angleDragHeliUp, _ahc.HeliRigidbody.linearVelocity.magnitude);
